...
$result = $conn->query("select * from appointment where status='pending' and law_office_id=$id");
$GLOBAL['countp']=$result->num_rows;

$result1 = $conn->query("select * from appointment where status='canceled' and law_office_id=$id");
$GLOBAL['countc']=$result1->num_rows;

$result2 = $conn->query("select * from appointment where status='accomodated' and law_office_id=$id");
