...
while ($row = mysqli_fetch_assoc($sqldata))	{
 ...
 $email=$row['email'];
 $pass=$row['pass'];
 $office_cnum=$row['office_contact'];
...
?>
       ...
       <tr>
       <strong> <td><strong>Office Address : </strong> </td></strong>
       ...
       <tr>
         <strong><td><strong>Office Contact Number : </strong> </td></strong>
    ...
    <div class='modal-dialog'>
      <div class='modal-content'>
        ...
        <div class='modal-body'>
          ...
          <div class="form-group">
            <label class="float-left">Office Contact Number</label>
            <input type="text" class="form-control" placeholder="<?php echo $office_cnum;  ?>" name="office_cnum" required>
          </div>
          <div class="form-group">
            <label class="float-left">Law Office Name</label>
            <input type="text" class="form-control" placeholder="<?php echo $office_name;  ?>" name="office_name" required>
          </div>
          <div class="form-group">
            <label class="float-left">Office Address</label>
            <input type="text" class="form-control" placeholder="<?php echo $address;  ?>" name="address" required>
          </div>
          <div class="form-group">
            <label class="float-left">Email</label>
            <input type="text" class="form-control" placeholder="<?php echo $email;  ?>" name="email" required>
          </div>
          <div class="form-group">
...
if(isset($_POST["update"])) {
  ...
  $sqlget = "UPDATE `atty` SET `office_name` = '".$_POST['office_name']."', `lname` = '".$_POST['lname']."', `fname` = '".$_POST['fname']."', `office_address` = '".$_POST['address']."', `email` = '".$_POST['email']."', `pass` = '".$pass."', `office_contact` = '".$_POST['office_cnum']."', `img` = '".$img1."' WHERE `atty`.`atty_id` = '".$_SESSION['logged_id']."';";
