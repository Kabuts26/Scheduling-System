...
if (isset($_GET['L'])) {
    ...
    $password = $_GET['pass2'];  
        ...
        $decpass = password_hash($password, PASSWORD_DEFAULT);
        
      
        $sql = "select * from client where email = '$username' and password = '$decpass'";  
        ...
        $count = mysqli_num_rows($result);  
          ...
          $_SESSION['logged_id']=$id;
            ...
            echo "<h1 align='center' style='font-size: 15px; margin:20px;'> Login failed. Invalid username or password.</h1>";  
        } 
