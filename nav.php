...
<script src="https://code.jquery.com/jquery-3.2.1.min.js"></script>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          <div class=" dropdown">
  <button style=" border: 2px #E3B7A0; " class="btn dropdown-toggle mr-5" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
  ...
  <?php 
    ...
    $sender =$_SESSION['logged_in'];
     $sqlget = "SELECT DISTINCT sender FROM message where receiver='$sender' ORDER BY id DESC";
     $sqldata = mysqli_query($conn, $sqlget) or die('Error Displaying Data'. mysqli_connect_error());
     while ($row = mysqli_fetch_assoc($sqldata)){
       $a= $row['sender'];
        echo "<a class='ml-3' href='chatbox.php?id=";
      echo $a."'><i class='bi bi-envelope'></i> ";
